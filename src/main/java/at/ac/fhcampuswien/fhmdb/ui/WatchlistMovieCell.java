...
public class WatchlistMovieCell extends ListCell<Movie>{
    ...
    private final VBox layout = new VBox(title, detail, genre, detailBtn, removeBtn);
    ...
    private WatchlistMovieCell.ClickEventHandler<Movie> onRemoveClicked;
    public WatchlistMovieCell(WatchlistMovieCell.ClickEventHandler<Movie> onRemoveClicked) {
        super();
        this.onRemoveClicked = onRemoveClicked;
        removeBtn.setOnMouseClicked(mouseEvent -> {
            try {
                System.out.println("Remove button clicked for movie: " + getItem().getTitle());
                onRemoveClicked.onClick(getItem());
                //System.out.println("Removed " + getItem().getTitle());
